...
There are a bunch of great built-in array methods in JavaScript. They can seem complicated, since they take a callback function as an argument. But they are very powerful and can make your code much more concise and readable.

To make them clearer, here is a simple implementation of a `List` class that has some of the same methods as JavaScript arrays. This is a good exercise to help you understand how these methods work.
